...
const handleDownloadCV = () => {
  ...
  link.href = "src/CV_Mohamed_Boulkassoum_Data_Engineering.pdf";
  link.download = 'src/CV_Mohamed_Boulkassoum_Data_Engineering.pdf';
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
          ...
          <div className="md:col-span-7 text-center md:text-left">
            ...
            <p className="text-lg md:text-xl text-portfolio-gray mb-6">
              Étudiant en Management des SI, passionné par l'ingénierie des données
            </p>
